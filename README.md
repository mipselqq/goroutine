...
- Secrecy:
- - A custom package to encapsulate credentials using the SecretString container to **prevent accidental** logging or marshalling even using unpopular verbs.
- - Basic request **limits** (body size, timeouts) are set up as a **second line of defense** against bugged clients and very simple DOS attacks.
