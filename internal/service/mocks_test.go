...
type MockUserRepository struct {
	...
	GetByEmailFunc func(ctx context.Context, email domain.Email) (id int64, hash string, err error)
}
...
func (m *MockUserRepository) GetByEmail(ctx context.Context, email domain.Email) (id int64, hash string, err error) {
