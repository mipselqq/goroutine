...
func (r *ErrorResponder) PayloadTooLarge(w http.ResponseWriter, details []Detail) {
	r.DetailedError(w, http.StatusRequestEntityTooLarge, "PAYLOAD_TOO_LARGE", details)
}
