...
func NewRouter(handlers *handler.Handlers, middlewares *middleware.Middlewares, telegramWebhook http.Handler) http.Handler {
	...
	mux.Handle("GET /v1/boards", protected(handlers.Boards.List))
	mux.Handle("POST /v1/boards/{boardId}/columns", protected(handlers.Columns.Create))
	mux.Handle("GET /v1/boards/{boardId}/columns", protected(handlers.Columns.List))
	...
	mux.Handle("GET /v1/boards/{boardId}/columns/{columnId}/tasks", protected(handlers.Tasks.List))
