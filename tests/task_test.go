...
func TestTask_HappyPath(t *testing.T) {
	...
	LinkTelegram(t, ac)
	p.MockTelegram.AssertMessagesCount(1)
	...
	p.MockTelegram.AssertMessagesCount(2)
	...
	p.MockTelegram.AssertMessagesCount(3)
	...
	p.MockTelegram.AssertMessagesCount(4)
	...
	p.MockTelegram.AssertMessagesCount(5)
	...
	p.MockTelegram.AssertMessagesCount(7)
	...
	p.MockTelegram.AssertMessagesCount(8)
	...
	p.MockTelegram.AssertMessagesCount(9)
	...
	p.MockTelegram.AssertMessagesCount(10)
	...
	p.MockTelegram.AssertMessagesCount(11)
	...
	p.MockTelegram.AssertMessagesCount(12)
